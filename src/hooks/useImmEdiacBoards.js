...
const defaultBoard2Cards = {
  ...
  "ws-sec-1": { id: "ws-sec-1", title: "Daily: OpenClaw Vulnerability Check", subtitle: "Check for updates, CVEs, and security advisories" },
  "ws-sec-2": { id: "ws-sec-2", title: "Daily: Browser Injection Audit", subtitle: "Review URLs/content passed to browser tool for injection vectors" },
...
const defaultBoard2Columns = [
  ...
  { id: "ws-col-7", title: "Security & Maintenance", cardIds: ["ws-sec-1", "ws-sec-2"] },
